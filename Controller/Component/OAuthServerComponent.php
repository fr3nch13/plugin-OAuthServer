...
require_once ROOT. DS. 'Vendor'. DS. 'nihfo-vendors/php-oauth2-server/lib/OAuth2.php';
require_once ROOT. DS. 'Vendor'. DS. 'nihfo-vendors/php-oauth2-server/lib/IOAuth2Storage.php';
require_once ROOT. DS. 'Vendor'. DS. 'nihfo-vendors/php-oauth2-server/lib/IOAuth2RefreshTokens.php';
require_once ROOT. DS. 'Vendor'. DS. 'nihfo-vendors/php-oauth2-server/lib/IOAuth2GrantUser.php';
require_once ROOT. DS. 'Vendor'. DS. 'nihfo-vendors/php-oauth2-server/lib/IOAuth2GrantCode.php';


class OAuthServerComponent extends Component implements IOAuth2Storage, IOAuth2RefreshTokens, IOAuth2GrantUser, IOAuth2GrantCode {
 ...
 * @var array
 */
	public $allowedActions = array('token', 'authorize', 'login', 'userinfo');
 ...
 */
	public function __construct(ComponentCollection $collection, $settings = array()) {
		...
		$this->AccessToken = ClassRegistry::init(array('class' => 'OAuthServer.AccessToken', 'alias' => 'AccessToken'));
		$this->AuthCode = ClassRegistry::init(array('class' => 'OAuthServer.AuthCode', 'alias' => 'AuthCode'));
		$this->Client = ClassRegistry::init(array('class' => 'OAuthServer.Client', 'alias' => 'Client'));
		$this->RefreshToken = ClassRegistry::init(array('class' => 'OAuthServer.RefreshToken', 'alias' => 'RefreshToken'));
	}
 ...
 */
	public function checkClientCredentials($client_id, $client_secret = null) {
		$conditions = array($this->Client->alias.'.client_id' => $client_id);
		if ($client_secret) {
			$conditions[$this->Client->alias.'.client_secret'] = $client_secret;
		}
 ...
 */
	...
	public function throwAclException($message = false)
	{
/*
		try {
			false;
...
*/		
		...
		$e = new OAuth2RedirectException($params["redirect_uri"], OAuth2::ERROR_UNSUPPORTED_GRANT_TYPE, $message);
		$e->sendHttpResponse();
	}
}
